...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Viagem dos Sonhos | Agente Autorizado CVC" },
      { property: "og:description", content: "Realizamos sonhos de viagem: passagens, pacotes, cruzeiros e viagens corporativas." },
