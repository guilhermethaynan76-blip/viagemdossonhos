    ...
    <section className="relative overflow-hidden bg-[#F0E9DA] py-28 text-[#0A2540]">
      ...
      <div className="mx-auto max-w-5xl px-4 text-center md:px-8">
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <img src="https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=1200&q=80" alt="Família curtindo viagem" className="h-80 w-full rounded-2xl object-cover shadow-lg" />
        </div>
      </div>
    </section>
  );
